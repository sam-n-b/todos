  ...
  return knex('todos').del()
    .then(function () {
      ...
      return knex('todos').insert([
        ...
        {id: 2, task: 'do this', priority: 1, category:'code', is_complete: true, due_at: 1553466745 },
        ...
        {id: 5, task: 'do this', priority: 4, category:'friends', is_complete: true, due_at: 1551655345 },
